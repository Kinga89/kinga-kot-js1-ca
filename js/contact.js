...
function validateForm() {
    ...
    let validForm = checkLength(firstName.value, 1) && checkLength(lastName.value, 1)&& checkLength(subject.value, 10) && validateEmail(email.value) && addressLength(address.value, 25);
